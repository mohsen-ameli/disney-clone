...
const HeroImg = ({ src, ...rest }) => {
  return (
    <div className="w-full h-full relative inline-block snap-center cursor-pointer md:img-big shadow" style={{ fontSize: 0 }} {...rest}>
      <div className="flex items-center relative">
        ...
        <div className="w-full h-[200px] sm:h-[250px] md:h-[350px] relative">
          <Image className='-z-10 rounded-md' src={src[1]} layout="fill" objectFit="cover" alt="Image Row" />
        </div>
      </div>
    </div>
  );
