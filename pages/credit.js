  ...
  return (
    <div className="w-full h-full">
      <div className="max-w-[1400px] mx-auto flex flex-col items-center">
        ...
        <p className="px-4">This is a clone and I made it for fun purposes. It does not have any copy righted material and I&apos;m not affiliated with Disney+ in any way.</p>
      </div>
    </div>
  );
}
